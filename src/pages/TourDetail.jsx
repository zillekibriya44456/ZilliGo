...
export default function TourDetail() {
  ...
  const similarTours = []; // Will implement DB fetch for similar tours if needed
  ...
  const tourType = tour.type || 'live'; // Default to live if not specified in DB
  ...
  const handleBook = async () => {
    ...
    if (tourType === 'live') {
      ...
      // Recorded tours can be joined immediately
      ...
      <div className="td-hero">
        ...
        <div className="container td-hero__content">
          ...
          <div className="td-hero__meta">
            ...
            <span><Globe size={15} /> {tour.language || 'English'}</span>
            {tourType === 'live' && <span><Users size={15} /> {spotsLeft} spots left</span>}
          </div>
        </div>
      </div>
        ...
        <div className="td-main">
          ...
          <section className="td-section">
            ...
            <div className="td-includes">
              {[
                { icon: '🎥', text: `${tourType === 'live' ? 'HD Live' : 'HD Recorded'} Video` },
        ...
        <aside className="td-sidebar">
          <div className="td-booking-card glass-card">
            ...
            <button 
              ...
              style={{ width: '100%', marginBottom: '0.75rem', marginTop: '1rem', opacity: (!selectedDate || !selectedTime) && tourType === 'live' ? 0.5 : 1 }} 
              onClick={handleBook}
            >
              {tourType !== 'live' ? '▶ Watch Now' : 
